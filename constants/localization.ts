...
const translations = {
    en: {
        ...
        broadcastTargetAws: 'AWS Display',
        broadcastTargetHymnSign: 'HymnSign',
        broadcastTargetBoth: 'Both',
        hymnSignSettings: 'HYMNSIGN',
        hymnSignHost: 'Sign IP Address',
        hymnSignHostPlaceholder: '192.168.1.42',
        hymnSignPort: 'Sign Port',
        hymnSignWifiNote: 'Your phone must be on the same WiFi as the sign.',
        hymnSignCloudNote: 'HymnSign is controlled over the cloud via AWS IoT Core. Signs must be online on church WiFi.',
        hymnSignBrightness: 'Set Brightness',
        hymnSignLargeBrightness: 'Hymn Number',
        hymnSignSmallBrightness: 'Verse Number',
        testHymnSignConnection: 'Test Connection',
        hymnSignConnectionSuccess: 'HymnSign command sent via IoT Core',
        ...
        easternCamp2026: 'EASTERN CAMP 2026',
        currentlySinging: 'Currently singing',
        viewCurrentSong: 'View',
        recommendedHymnBanner: 'Recommended Hymn Banner',
        easternCamp: 'EASTERN CAMP',
        ...
        deleteHymnals: 'Remove All Hymnals',
        resetData: 'Reset All Data',
        clearCacheConfirmation: 'Clear Cache?',
        deleteHymnalsConfirmation: 'Remove All Hymnals?',
        clearCacheConfirmationMessage: 'This will delete all cached files created by the app.',
        deleteHymnalsConfirmationMessage: 'This will remove all hymnals currently downloaded.',
        resetDataConfirmation: 'Reset All Data?',
        resetDataConfirmationMessage: 'This will delete everything, including bookmarks and settings. This cannot be undone.',
    ...
    es: {
        ...
        resetDataConfirmation: '¿Restablecer todos los datos?',
        resetDataConfirmationMessage: 'Esto eliminará todo, incluidos los marcadores y la configuración. Esta acción no se puede deshacer.',
    ...
    fr: {
        ...
        resetDataConfirmation: 'Réinitialiser toutes les données?',
        resetDataConfirmationMessage: 'Cela supprimera tout, y compris les marque-pages et les paramètres. Cette action est irréversible.',
    ...
    de: {
        ...
        resetDataConfirmation: 'Alle Daten zurücksetzen?',
        resetDataConfirmationMessage: 'Dies wird alles löschen, einschließlich Lesezeichen und Einstellungen. Dies kann nicht rückgängig gemacht werden.',
    ...
    sr: {
        ...
        resetData: 'Resetovati sve podatke',
        ...
        resetDataConfirmation: 'Resetovati sve podatke?',
        resetDataConfirmationMessage: 'Ovo će obrisati sve, uključujući obeleživače i podešavanja. Ovo se ne može poništiti.',
    ...
    ja: {
        ...
        resetDataConfirmation: 'すべてのデータをリセットしますか？',
        resetDataConfirmationMessage: 'ブックマークや設定を含むすべてが削除されます。この操作は取り消せません。',
